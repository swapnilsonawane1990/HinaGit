...
public class AutomationRunnerHub {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to Hub AutomationRunner!!!");
        ...
        try {
            ...
            BaseTempletSteps.setDriver(driverutil.getRemoteDriver(browser));
