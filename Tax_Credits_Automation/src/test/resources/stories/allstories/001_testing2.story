Narrative:
As a user
I want to perform State Export Action
So that user get the state export files for given state

Scenario: User perform screening test
Given User log in for screening process
Given User perform screening test

Examples:
test//000_testing.table
