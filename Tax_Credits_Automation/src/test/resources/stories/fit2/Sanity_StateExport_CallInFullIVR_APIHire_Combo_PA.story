...
Narrative:
As a user I want to perform an action So that I can achieve a business goal

Scenario: User Perform Call In Screening API Hire Combo and For Pennsylvania State
...
Examples:
fit2//Sanity_StateExport_CallInFullIVR_APIHire_Combo_PA.table