...
Then User should be able to see all the correct details on Exported Files for IA State
!-- And Verify State Export Data file for state IA 

Examples:
fit2//Sanity_StateExport_XML_In_Screening_APIHire_Combo_IA.table
